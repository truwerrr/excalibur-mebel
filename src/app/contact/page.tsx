...
const ContactPage = () => {
  ...
  const contactInfo = {
    ...
    email: 'excaliburkz@excalibur.com',
    ...
    social: {
      instagram: '@mebel_zhinaz_excalibur',
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contactInfo.phone}`} className="text-lg font-medium text-amber-600 hover:text-amber-700">
                      {contactInfo.phone}
                    </a>
                  </div>
                </div>
